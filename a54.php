...
<body>
<form method="post" enctype="multipart/form-data" action="a54.php">
<table border="2">
<tr>
...
{
$mysql=new mysqli("localhost","root","","maithri");
if(!$mysql) 
{
	die("ERROR!!!");
}
...
if(!empty($_FILES["photo"]["name"]))
{
	...
	$sql="update passport set fname='$fname',mname='$mname',lname='$lname',dob='$dob',nationality='$nationality',address='$address',gender='$gender',img='$filepath' where pno=$pno";
